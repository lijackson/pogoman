...
async function getRecordsByLevel(lvl_id) {
    ...
    const client_facing_records = records.map(dbRecord => mapDBRecordToClientRecord(dbRecord, dbRecord.account_id ? users.find(u => u._id.toString() === dbRecord.account_id) : null)).toArray();
